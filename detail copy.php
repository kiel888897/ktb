                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide cursor-pointer">
                                <img src="assets/img/tv1.webp"
                                    class="h-20 mx-auto object-contain border rounded-lg p-2">
                            </div>

                            <div class="swiper-slide cursor-pointer">
                                <img src="assets/img/tv2.webp"
                                    class="h-20 mx-auto object-contain border rounded-lg p-2">
                            </div>

                            <div class="swiper-slide cursor-pointer">
                                <img src="assets/img/tv3.webp"
                                    class="h-20 mx-auto object-contain border rounded-lg p-2">
                            </div>
            ...
            <div data-aos="fade-left">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="mailto:info@kusumatrismabali.com"
                        class="inline-flex items-center px-6 py-3 bg-blue-600 text-white
