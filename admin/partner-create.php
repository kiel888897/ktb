...
<head>
    ...
    <title>Add Partner | Kusuma Trisna Bali</title>
                ...
                <div class="mx-auto max-w-7xl p-4 md:p-6">
                    ...
                    <div class="mb-6 flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                                Tambahkan partner baru beserta logo.
                            </p>
                        </div>
                   ...
                   bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        <div class="p-5 sm:p-6">
                            ...
                            <form action="partner-store.php" method="POST" enctype="multipart/form-data"
                           ...
                           dark:border-gray-700 dark:text-white/90" />
                             ...
                             dark:border-gray-800 dark:bg-white/[0.03]">
                                            <img id="logoPreview"
                                                src="uploads/partners/default.png"
                                                alt="Preview"
