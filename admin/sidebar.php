                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a
                            ...
                            class="menu-item group"
                            :class="(selected === 'Tables') || (page === 'Product' || page === 'Service') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg
                                :class="(selected === 'Tables') || (page === 'Product' || page === 'Service') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <ul
                                ...
                                <li>
                                    <a
                                        href="product.php"
                                        class="menu-dropdown-item group"
                                        :class="page === 'Product' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Product
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href="service.php"
                                        class="menu-dropdown-item group"
                                        :class="page === 'Service' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Service
                                    </a>
                                </li>
                            </ul>
                    ...
                    <li>
                        <a
                            ...
                            class="menu-item group"
                            :class="(selected === 'Master') || (page === 'fileManager' || page === 'Brand' || page === 'Kategori' || page === 'Subkategori' || page === 'page500' || page === 'page503' || page === 'success' || page === 'faq' || page === 'comingSoon' || page === 'maintenance') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg
                                :class="(selected === 'Master') || (page === 'fileManager' || page === 'Brand' || page === 'Kategori' || page === 'Subkategori' || page === 'page500' || page === 'page503' || page === 'success' || page === 'faq' || page === 'comingSoon' || page === 'maintenance') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                            ...
                            <ul
                                ...
                                <li>
                                    <a
                                        href="brand.php"
                                        class="menu-dropdown-item group"
                                        :class="page === 'Brand' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'">
                                        Brand
                                    </a>
                                </li>
                                <li>
            ...
            <div>
                ...
                <ul class="flex flex-col gap-4 mb-6">
                    ...
                    <li>
                        <a
                            href="partner.php"
                            @click="selected = (selected === 'Partner' ? '':'Partner')"
                            class="menu-item group"
                            :class=" (selected === 'Partner') && (page === 'partner') ? 'menu-item-active' : 'menu-item-inactive'">
                            <svg
                                :class="(selected === 'Partner') && (page === 'partner') ?  'menu-item-icon-active'  :'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
